// This code is for the home section - temporary, will convert to component after adding context
  ...
  return (
    <>
      <div className="container   mb-5 mt-5  pb-5">
        ...
        <Link className="btn btn-dark mt-5 px-20" to="/Books" role="button">
          More Books
        </Link>
      </div>
    </>
